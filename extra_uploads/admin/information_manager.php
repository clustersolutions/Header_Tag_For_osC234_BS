        ...
        foreach($languages_ids as $_language_id) {
          if (!in_array($_language_id, $information_languages)) {
            $sql_data_array = array(
              ...
              'information_seo_title'       => tep_db_prepare_input($information['information_seo_title']),
              'information_seo_meta_description'       => tep_db_prepare_input($information['information_seo_meta_description']),
              'information_seo_meta_keywords'       => tep_db_prepare_input($information['information_seo_meta_keywords'])
            );
...
// WT
  ...
  switch($action) {
    ...
    case "AddSure":
      ...
      if (isset($_POST['information_seo_title']))
        $sql_data_array['information_seo_title'] = tep_db_prepare_input($_POST['information_seo_title'][$language_id]);
      if (isset($_POST['information_seo_meta_description']))
        $sql_data_array['information_seo_meta_description'] = tep_db_prepare_input($_POST['information_seo_meta_description'][$language_id]);
      if (isset($_POST['information_seo_meta_keywords']))
        $sql_data_array['information_seo_meta_keywords'] = tep_db_prepare_input($_POST['information_seo_meta_keywords'][$language_id]);
