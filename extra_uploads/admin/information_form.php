...
?>
        <tr>
          <td valign="top" class="main" width="100" colspan="2"><?php if ($i == 0) echo ENTRY_DESCRIPTION; ?><br />
            <table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                          <td class="main"><?php echo ENTRY_SEO_TITLE ?></td>
                          <td align="left" class="main"><?php echo tep_draw_input_field('information_seo_title[' . $languages[$i]['id'] . ']', (isset($information_seo_title[$languages[$i]['id']]) ? stripslashes($edit['information_seo_title']) : tep_get_information_entry($information_id, $languages[$i]['id'], 'information_seo_title')), 'maxlength=255 size=75'); ?></td>
                        </tr>
                        <tr><td colspan="2"><br><br></td></tr>
                        <tr>
                          <td class="main"><?php echo ENTRY_SEO_DESCRIPTION ?></td>
                          <td align="left" class="main"><?php
                          echo tep_draw_textarea_field(
                          'information_seo_meta_description[' . $languages[$i]['id'] . ']',
                          '',
                          '70',
                          '20',
                          (isset($information_seo_meta_description[$languages[$i]['id']]) ? stripslashes($edit['information_seo_meta_description']) : tep_get_information_entry($information_id, $languages[$i]['id'], 'information_seo_meta_description')));
                       ?>
                       </td>
                        </tr>
                        <tr><td colspan="2"><br><br></td></tr>
                        <tr>
                          <td class="main"><?php echo ENTRY_SEO_KEYWORDS ?></td>
                          <td align="left" class="main">
                          <?php echo tep_draw_input_field('information_seo_meta_keywords[' . $languages[$i]['id'] . ']', (isset($information_seo_title[$languages[$i]['id']]) ? stripslashes($edit['information_seo_title']) : tep_get_information_entry($information_id, $languages[$i]['id'], 'information_seo_meta_keywords')), 'style="width: 300px;" placeholder="' . PLACEHOLDER_COMMA_SEPARATION . '"'); ?></td>
                        </tr>
