...
if (tep_not_null($category['categories_description'])) {
  ?>
  <div class="categoryText"><?php echo $category['categories_description']; ?></div>
  <?php
}
?>
...
?>
    ...
    if (tep_not_null($categories['categories_description'])) {
      ?>
      <div class="categoryText"><?php echo $categories['categories_description']; ?></div>
      <?php
    }
    ?>
...
if (tep_not_null($image['catdesc'])) {
  ?>
  <div class="categoryText"><?php echo $image['catdesc']; ?></div>
  <?php
}
?>
